...
Functional description:
    This is designed to search
    '/MPATHB/resource/compound/chebi/chebi.map' to get the
...
def cmdparameter(argv):
    ...
    parser.add_option("-f", "--chebi-table", dest="chebi",
        metavar="CHEBI-TABLE",
        default="/MPATHB/resource/compound/chebi/chebi.map",  
        help="Default /MPATHB/resource/compound/chebi/chebi.map .")
    parser.add_option("-c", "--column", dest="col",
        default=8, help="1-based number to indicate the column \
one wants to get. Default 8 to get the kegg compound id.")

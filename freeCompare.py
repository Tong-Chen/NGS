...
def output(aDict, prefix):
    ...
    for label, valueS in aDict.items():
        ...
        print >>all_desp, "%s\t%s" % (label, label)
    #------------------
    all.close()
    all_desp.close()
#--------END output---------------
def GetIDs(labelL, dataD):
    ...
    if isinstance(labelL, str):
        ...
        return aSet
#----------------------------
def intersect(compareSamp, op, dataD, aDict, reverse):
    '''
    ...
    #---------------------------------------------
#-----------intersect--------------------------
def compare(compareSamp, typeL, op, dataD, aDict, reverse):
    if debug:
